...
namespace Extensions.View
{
    ...
    {
        public CSVConverter() : base("CSV to robot targets", "CSVRobot", "Converts a CSV file to robot targets.", "Extensions", "Toolpaths") { }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var converter = new Extensions.Toolpaths.CSVConverter(file, target.Value as CartesianTarget, mask, reverse, cuttingSpeed, point);
